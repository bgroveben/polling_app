...
def create_question(question_text, days):
    """
    Creates a question with the given 'question_text' and publishes the given number of 'days' offset to now
...
class QuestionIndexDetailTests(TestCase):
    def test_detail_view_with_a_future_question(self):
        """
        The detail view of a question with a future pub_date should return a 404 not found.
        """
    ...
    def test_detail_view_with_a_past_question(self):
        """
        The detail view of a question with a past pub_date should display the question text.
        """
        pat_question = create_question(question_text='Past Question.', days=-5)
